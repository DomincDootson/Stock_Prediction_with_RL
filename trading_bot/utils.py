...
def show_train_result(result, val_position, initial_offset) -> None:
...
def get_stock_data(stock_file : str) -> list[float]:
    """Reads stock data from csv file"""
    df = pd.read_csv(stock_file)['Adj Close']
    return list(df)


def switch_k_backend_device() -> None:
